      ...
      <div class="auth-cover-card-wrapper">
        <div class="auth-cover-card p-sm-5">
          ...
          <p class="fs-12 fw-medium text-muted">
            Thank you for get back <strong>Nelel</strong> web applications, let's access
          ...
          <form action="index.html" class="w-100 mt-4 pt-2">
            ...
            <div class="d-flex align-items-center justify-content-between">
              ...
              <div>
                <a href="auth-reset-cover.html" class="fs-11 text-primary"
                  >Forget password?</a
                >
              </div>
            </div>
          ...
          <div class="w-100 mt-5 text-center mx-auto">
            <div class="mb-4 border-bottom position-relative">
              <span
                class="small py-1 px-3 text-uppercase text-muted bg-white position-absolute translate-middle"
                >or</span
              >
            </div>
            <div class="d-flex align-items-center justify-content-center gap-2">
              ...
              <a
                ...
                data-bs-trigger="hover"
                title=""
                data-bs-original-title="Login with Github"
              >
