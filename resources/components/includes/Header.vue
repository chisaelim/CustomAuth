                                ...
                                <div class="d-lg-flex align-items-start">
                                    ...
                                    <div class="tab-content nxl-mega-menu-tabs-content">
                                        ...
                                        <div class="tab-pane fade show active" id="v-pills-general" role="tabpanel">
                                            ...
                                            <a href="javascript:void(0);" class="fs-13 fw-bold text-primary">Get Started →</a>
                                        </div>
                                        <!--! [End] v-pills-general !-->
                                        ...
                                        <div class="tab-pane fade" id="v-pills-applications" role="tabpanel">
                                            ...
                                            <div class="d-lg-flex align-items-center justify-content-between">
                                                ...
                                                <div class="mt-2 mt-lg-0">
                                                    <a href="mailto:flexilecode@gmail.com" class="fs-13 fw-bold text-primary">Contact Us →</a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="tab-pane fade" id="v-pills-integrations" role="tabpanel">
                                            <div class="row g-lg-4 nxl-mega-menu-integrations">
                                                <div class="col-lg-12 d-lg-flex align-items-center justify-content-between mb-4 mb-lg-0">
                                                    ...
                                                    <div class="mt-2 mt-lg-0">
                                                        <a href="javascript:void(0);" class="fs-13 text-primary">Add New →</a>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                        ...
                                        <div class="tab-pane fade" id="v-pills-components" role="tabpanel">
                                            <div class="row g-4 align-items-center">
                                                ...
                                                <div class="col-xl-4">
                                                    ...
                                                    <div class="mt-4">
                                                        <a href="mailto:flexilecode@gmail.com" class="fs-13 fw-bold">View all resources on Duralux →</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                            ...
                                                            <div class="row g-4">
                                                                ...
                                                                <div class="col-lg-12">
                                                                    <div class="p-3 bg-soft-dark text-dark rounded d-lg-flex align-items-center justify-content-between">
                                                                        ...
                                                                        <div class="mt-2 mt-lg-0">
                                                                            <a href="javascript:void(0);" class="fs-13 text-primary">Learn More →</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="tab-pane fade" id="v-pills-features" role="tabpanel">
                                                    <div class="row g-4 nxl-mega-menu-miscellaneous-features">
                                                        ...
                                                        <div class="col-xxl-3 offset-xxl-1 col-xl-4">
                                                            ...
                                                            <div class="mt-4">
                                                                <a href="mailto:flexilecode@gmail.com" class="fs-13 fw-bold">View all features on Duralux →</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-language-dropdown">
                            ...
                            <div class="language-items-wrapper">
                                <div class="select-language px-4 py-2 hstack justify-content-between gap-4">
                                    ...
                                    <a href="javascript:void(0);" class="avatar-text avatar-md" data-bs-toggle="tooltip" title="" data-bs-original-title="Add Language">
                                        <i class="feather-plus"></i>
                                    </a>
                                </div>
                                <div class="dropdown-divider"></div>
                    ...
                    <div class="dropdown nxl-h-item">
                        ...
                        <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-timesheets-menu">
                            <div class="d-flex justify-content-between align-items-center timesheets-head">
                                ...
                                <a href="javascript:void(0);" class="fs-11 text-success text-end ms-auto" data-bs-toggle="tooltip" title="" data-bs-original-title="Upcomming Timers">
                                    <i class="feather-clock"></i>
                                ...
                                <div class="notifications-desc">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="d-flex align-items-center float-end gap-2">
                                            <a href="javascript:void(0);" class="d-block wd-8 ht-8 rounded-circle bg-gray-300" data-bs-toggle="tooltip" title="" data-bs-original-title="Make as Read" aria-label="Make as Read"></a>
                                            <a href="javascript:void(0);" class="text-danger" data-bs-toggle="tooltip" title="" data-bs-original-title="Remove">
